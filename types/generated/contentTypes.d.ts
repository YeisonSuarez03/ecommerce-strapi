...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhatsappTemplate: Schema.Attribute.Component<
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    PrincipalBanner: Schema.Attribute.Component<'shared.banner', false> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::place.place'> &
      Schema.Attribute.Private;
    minSize: Schema.Attribute.Decimal & Schema.Attribute.Required;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPriceTypePriceType extends Struct.CollectionTypeSchema {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attributes: Schema.Attribute.Component<'shared.attribute-selector', true>;
    brand: Schema.Attribute.Relation<'oneToOne', 'api::brand.brand'>;
    category: Schema.Attribute.Relation<'oneToOne', 'api::categoria.categoria'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    extra_prices: Schema.Attribute.Component<'shared.price-selector', true>;
